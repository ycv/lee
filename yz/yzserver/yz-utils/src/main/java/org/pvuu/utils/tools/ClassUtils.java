...
public class ClassUtils {
     ...
     * @return Class[]    返回类型</p>
     * @throws
     * @Description: TODO(根据对象获取他的所有父接口)
     * @方法名: getAllInterfaces</ p>
     * <p>@param ： @param instance
    ...
    /**
     * @return Set<Class>    返回类型</p>
     * @throws
     * @Description: TODO(根据一个对象获取它所有的接口 并返回Set集合)
     * @方法名: getAllInterfacesAsSet</ p>
     * <p>@param ： @param instance
     * <p>@param ： @return    设定文件</p>
     */
