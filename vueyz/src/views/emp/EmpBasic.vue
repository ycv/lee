<template>
  <div>
    <div>
      <div style="display: flex;justify-content: space-between">
        ...
        <div>
          ...
          <el-button type="primary" icon="el-icon-plus" @click="cTest">
            测试
          </el-button>
        </div>
      </div>
    ...
    <div style="margin-top: 10px">
      <!--      stripe-->
      <el-table
          :data="emps" :row-class-name="tableRowClassName"
    ...
    <el-dialog
      ...
      <div>
        <el-form :model="emp" :rules="rules" ref="empForm">
          <el-row>
            <el-col :span="6">
              <el-form-item label="姓名2:" prop="name">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="电子邮箱2:" prop="email">
          ...
          <el-row>
            ...
            <el-col :span="7">
              <el-form-item label="电话号码2:" prop="phone">
          ...
          <el-row>
            ...
            <el-col :span="6">
              <el-form-item label="转正日期6:" prop="conversionTime">
                <el-date-picker
      ...
      <span slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="doAddEmp">确 定2</el-button>
      </span>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    cTest() {
      console.log("sss");
      let multipleSelectionCode = "121212";
      multipleSelectionCode = "?code=" + multipleSelectionCode
      this.$Progress.start();
      stockRsiApi.actionTest(multipleSelectionCode).then(resp => {
        console.log(resp);
        if (resp && resp.status == 200) {
        }
        this.$Progress.finish();
      })
      mymessage.warning("aa11s44");
    },
    showAddEmpView() {
      this.emptyEmp();
      this.title = '添加员工';
